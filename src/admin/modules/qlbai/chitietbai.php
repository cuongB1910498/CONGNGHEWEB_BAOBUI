...
<div class="row">
    ...
    <div class="mb-3">
        ...
        ?>
        <img src="../modules/ql_cv/uploads/<?php echo $row['anhbia'] ?>" alt="error" width="10%" height="100px">
        <?php
            }
        ?>
    </div>
...
<div class="row">
    <?php
        if($row['trangthai'] == -1){
            echo '<button class="btn btn-danger col-1 disabled" type="button">ĐÃ XÓA</button>';
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <a href="modules/qlbai/xoabai.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Xóa</a>
        </div>
        </div>
    </div>
    </div>
